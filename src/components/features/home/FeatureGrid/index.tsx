...
const FEATURE_LAYOUT = [
  { id: 1, photo: '/assets/photo-salon.jpg.jpg', colSpan: '1 / span 7', rowSpan: '1 / span 3', tall: true },
  ...
  { id: 4, photo: '/assets/schody.jpg', colSpan: '1 / span 5', rowSpan: '4 / span 3', tall: true },
          ...
          {items.map((item) => (
            ...
            >
              ...
              <div
                ...
                style={{ background: 'linear-gradient(180deg, transparent 40%, rgba(26,36,25,0.88) 100%)' }}
              />
              <div className={`absolute bottom-0 left-0 right-0 text-brand-sunlight ${item.tall ? 'p-6 lg:p-7' : 'px-5 py-4 lg:px-6 lg:py-5'}`}>
                <h3 className={`m-0 font-display font-medium tracking-[-0.015em] ${item.tall ? 'text-[22px] lg:text-[28px]' : 'text-[17px] lg:text-[20px]'}`}>
                  {item.title}
                </h3>
