        ...
        >
          ...
          <div className="hidden lg:contents" style={{ display: 'contents' }}>
            ...
            >
              ...
              >
                <span className="text-[11px] tracking-widest2 uppercase font-semibold opacity-70">{t('summerSeason')}</span>
    ...
    <section id="top" className="relative bg-green-900 text-brand-sunlight">
      <div className="relative h-[480px] sm:h-[580px] md:h-[660px] lg:h-[760px] overflow-hidden">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(180deg, rgba(26,36,25,0.3) 0%, transparent 35%, rgba(26,36,25,0.75) 100%)' }}
        />
        ...
        <div className="relative h-full max-w-container mx-auto px-5 md:px-8 lg:px-16 py-10 md:py-14 lg:py-20 flex flex-col justify-between">
          <div className="flex justify-between items-start gap-4">
            ...
            <div className="sm:hidden" style={{ color: '#e3c66e' }}>
              <SmallCap className="text-mustard-300">{t('season')}</SmallCap>
            </div>
            <div className="flex flex-col gap-1 items-end shrink-0">
              <span className="text-[11px] tracking-[0.24em] uppercase text-mustard-300">{t('season')}</span>
              <a href="#rezerwacja" className="hidden sm:block text-[13px] font-semibold text-brand-sunlight no-underline hover:text-mustard-300 transition-colors duration-150">{t('openBookings')}</a>
            </div>
          </div>
