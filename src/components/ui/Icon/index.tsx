...
export const Icon = ({ color = 'currentColor', name, size = 20, stroke = 1.6 }: IconProps) => {
  const props = {
    width: size,
    height: size,
  ...
  switch (name) {
    ...
    case 'bed':
      return (
        <svg {...props}>
          <path d="M2 18v-7a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v7M2 14h20M6 9V7a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2" />
        </svg>
      );
    case 'wifi':
      return (
    ...
    case 'fire':
      return (
        <svg {...props}>
          <path d="M8.5 14.5A2.5 2.5 0 0 0 11 17c1.66 0 3-1.34 3-3 0-1.93-1.5-3.5-1.5-5.5a3.5 3.5 0 0 0-7 0c0 2 2 3.5 2 5.5a2.5 2.5 0 0 0 1 1.5" />
          <path d="M12 22c5 0 9-3.58 9-8 0-3.5-2-6-4-8 0 3-2 5-5 5s-5-2-5-5c-2 2-4 4.5-4 8 0 4.42 4 8 9 8z" />
        </svg>
      );
    case 'tree':
      return (
        <svg {...props}>
          <path d="M12 2 6 9h3l-4 5h3l-3 4h14l-3-4h3l-4-5h3z" />
          <path d="M12 18v4" />
        </svg>
      );
    case 'pin':
